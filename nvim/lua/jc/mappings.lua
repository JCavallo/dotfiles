...
local map_tele = function(key, f, options, buffer, no_prefix)
	...
	local mode = "n"
	local rhs = string.format("<cmd>lua require('jc.telescope')['%s'](TelescopeMapArgs['%s'])<CR>", f, map_key)
...
map_tele("<F1>", "force_refresh_treesitter", { symbols = { "type" } }, false, true)
map_tele("ltf", "force_refresh_treesitter", { symbols = { "function" } })
...
map_tele("sdtm", "tryton_model_grep", { mode = "current", path = "directory" })
map_tele("sdtwm", "tryton_model_grep", { mode = "ask", path = "directory" })
map_tele("sdtcm", "tryton_model_grep", { mode = "cursor", path = "directory" })
map_tele("sdtf", "tryton_field_directory_grep")
map_tele("smtm", "tryton_model_grep", { mode = "current", path = "module" })
map_tele("smtwm", "tryton_model_grep", { mode = "ask", path = "module" })
map_tele("smtcm", "tryton_model_grep", { mode = "cursor", path = "module" })
map_tele("smtf", "tryton_field_module_grep")
map_tele("sgtm", "tryton_model_grep", { mode = "current", path = "git" })
map_tele("sgtwm", "tryton_model_grep", { mode = "ask", path = "git" })
map_tele("sgtcm", "tryton_model_grep", { mode = "cursor", path = "git" })
map_tele("sgtf", "tryton_field_git_grep")
map_tele("sptm", "tryton_model_grep", { mode = "current", path = "project" })
map_tele("sptwm", "tryton_model_grep", { mode = "ask", path = "project" })
map_tele("sptcm", "tryton_model_grep", { mode = "cursor", path = "project" })
map_tele("sptvm", "tryton_model_grep", { mode = "clipboard", path = "project" })
map_tele("<F8>", "tryton_model_grep", { mode = "current", path = "project" }, false, true)
map_tele("<F9>", "tryton_function_grep", { mode = "current", path = "project" }, false, true)
...
map(
	"<M-b>B",
	[[<cmd>lua require('dap').toggle_breakpoint(vim.fn.input 'Breakpoint condition: ', vim.fn.input 'Hit condition: ') <CR>]]
)
...
map(
	"<Leader>cp",
	':let @+=expand("%:p")<CR>:echo "Copied current file ' .. 'path \'".expand("%:p")."\' to the clipboard"<CR>"'
)
...
--View Navigation --
--------------------
local function map_view(key, rhs)
	map("<C-w>" .. key, rhs)
end
